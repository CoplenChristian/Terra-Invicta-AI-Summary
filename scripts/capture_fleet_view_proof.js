/**
 * scripts/capture_fleet_view_proof.js
 *
 * Purpose: capture FLEET view rendered text and panel-mount geometry for
 *   before/after refactor proof. Adapted from capture_expansion_view_proof.js.
 */
  ...
  try {
    for (const mode of MODES) {
      ...
      for (const vp of VIEWPORTS) {
        ...
        await page.goto(`http://127.0.0.1:${port}${SHELL_PATH}#/fleet`, {
