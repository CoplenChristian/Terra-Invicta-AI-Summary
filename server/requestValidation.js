...
module.exports = {
  ...
  DRIVE_THRESHOLD_FILTERS: shared.DRIVE_THRESHOLD_FILTERS,
  DRIVE_THRESHOLD_PARAMETERS: shared.DRIVE_THRESHOLD_PARAMETERS,
  THRESHOLD_REJECTION_REASON: shared.THRESHOLD_REJECTION_REASON,
  parseMinimumThreshold: shared.parseMinimumThreshold,
  parseDriveThresholds: shared.parseDriveThresholds,
