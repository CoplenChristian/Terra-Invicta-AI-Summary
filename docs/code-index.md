...
| `public/v2/js/mission-control.js` | BS | Browser (classic, global IIFE) | 2167 | the v2 dashboard controller — briefing fetch, mode switching, and | `onCopyExport, onOpenFaction` | — |
...
| `shared/battleComposition.mjs` | E | Node + Cloudflare worker (ESM) | 622 | phase 0 + phase 1 of docs/engagement-matchup-spec.md — the weapon | `INTERCEPTION_ASSUMPTION, MAX_BATTLE_SIDE_SHIPS, MAX_BATTLE_SIDE_SHIPS_ATTRIBUTION, PD_OVERWHELM_MULTIPLE, PD_OVERWHELM_RULE_ATTRIBUTION, PD_TARGETABLE_FAMILY_FALLBACK, SALVO_SHOTS_WHEN_ABSENT, buildWeaponIndex, composeBattleSide, normalizeWeaponName, saturationVerdict` | `tests/battleComposition.test.js` |
...
| `src/v2/components/TwoColumnGrid.jsx` | E | Browser (React JSX) | 73 | reusable MUI Grid2 layout primitive mirroring `.init-view__grid` — | `TwoColumnGrid, TwoColumnGridItem` | — |
