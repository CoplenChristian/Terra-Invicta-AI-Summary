...
| `src/v2/components/Panel.jsx` | E | Browser (React JSX) | 73 | React replacement for `.tech-card` — header, title, body, and all six | `Panel` | — |
...
| `src/v2/panels/battlePanelUtils.mjs` | E | Browser (React JSX) | 164 | testable fleet-picker and battle-cap logic behind BattlePanel.jsx. | `BATTLE_SHIP_CAP_ATTRIBUTION, BATTLE_SHIP_CAP_PER_SIDE, buildShipDesignLookup, deploymentSummary, factionsWithFleets, fleetById, fleetsForFaction, overCapNotice, presentCount, resolveShipDesignSubtitle, sameId, selectionBlocked, …(+2)` | `tests/battlePanelUtils.test.js` |
...
| `src/v2/panels/FleetPicker.jsx` | E | Browser (React JSX) | 360 | faction and fleet selectors with a capped ship checklist for the battle planner. | `FleetPicker` | — |
