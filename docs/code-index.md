...
| `server/engine/military.js` | C | Node (CommonJS) | 554 | the military read-model — assemble the observer's military facts into | `MODULE_TIER_SOURCE_TABLE, MODULE_TIER_SOURCE_UNKNOWN, buildMilitaryWorld, buildTheaterForce, resolveModuleTier` | — |
